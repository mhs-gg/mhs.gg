...
export default function SignUp() {
  return (
    <form action={'/api/signup'} method = 'POST' className="max-w-lg mx-auto bg-white p-8 rounded-lg shadow-md">
      ...
      <input className="w-full bg-blue-500 text-white font-bold py-2 px-4 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50" type="submit" value="Signup"/>
    </form>
  )
}
